...
elh.shomareelhaghiye as "CmpDocNo",
'2610' as "MapFldDtlCod",
elh.mablagheelhaghiye as "Prm",
...
pish.karmozd as "Wag"
 ...
 from  
          DMN_ELHAGHIYE elh join 
          DMN_BIMENAME bm on elh.bimename_id = bm.id join
   ...
   where taahodfot.noetaahod = 'FOT' and elh.shomareelhaghiye is not null;      
