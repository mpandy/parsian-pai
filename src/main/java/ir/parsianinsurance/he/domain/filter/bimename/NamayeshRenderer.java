...
public class NamayeshRenderer implements Serializable{
    ...
    public Object filter(InvocationContext ctx) throws Exception {
        try{
            ...
            VaziateBimename state = bimenameBean.getBimename().getVaziateBimename();
            if (state.equals(VaziateBimename.MOVAGHAT))
                bimenameFilter.hidePanelBimename();
