...
@XmlRootElement(name = "SubmitFullArchiveNameInq")
public class SubmitFullArchiveNameInq {

    @XmlElementRef(name = "archiveName", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
