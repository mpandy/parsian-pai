...
@XmlRootElement(name = "SubmitNationalIdInq")
public class SubmitNationalIdInq {

    @XmlElementRef(name = "nationalId", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
