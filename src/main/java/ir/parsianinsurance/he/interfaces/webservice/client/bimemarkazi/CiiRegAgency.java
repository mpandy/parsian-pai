 ...
 *       &lt;sequence>
 *         &lt;element name="Pr" type="{http://schemas.datacontract.org/2004/07/}WbsV4AgncReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegAgency")
public class CiiRegAgency {

    @XmlElementRef(name = "Pr", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4AgncReq> pr;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4AgncReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4AgncReq> getPr() {
        return pr;
    }
     ...
     *     
     */
    public void setPr(JAXBElement<WbsV4AgncReq> value) {
        this.pr = value;
    }
