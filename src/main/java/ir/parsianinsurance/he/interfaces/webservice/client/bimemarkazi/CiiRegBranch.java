 ...
 *       &lt;sequence>
 *         &lt;element name="Pr" type="{http://schemas.datacontract.org/2004/07/}WbsV4BranchReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegBranch")
public class CiiRegBranch {

    @XmlElementRef(name = "Pr", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4BranchReq> pr;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4BranchReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4BranchReq> getPr() {
        return pr;
    }
     ...
     *     
     */
    public void setPr(JAXBElement<WbsV4BranchReq> value) {
        this.pr = value;
    }
