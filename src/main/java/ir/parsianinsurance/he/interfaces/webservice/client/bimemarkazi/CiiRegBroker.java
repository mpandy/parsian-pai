 ...
 *       &lt;sequence>
 *         &lt;element name="Pr" type="{http://schemas.datacontract.org/2004/07/}WbsV4BrokerReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegBroker")
public class CiiRegBroker {

    @XmlElementRef(name = "Pr", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4BrokerReq> pr;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4BrokerReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4BrokerReq> getPr() {
        return pr;
    }
     ...
     *     
     */
    public void setPr(JAXBElement<WbsV4BrokerReq> value) {
        this.pr = value;
    }
