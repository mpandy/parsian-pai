 ...
 *       &lt;sequence>
 *         &lt;element name="Pr" type="{http://schemas.datacontract.org/2004/07/}WbsV4PlcyReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegChkPlcy")
public class CiiRegChkPlcy {

    @XmlElementRef(name = "Pr", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4PlcyReq> pr;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4PlcyReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4PlcyReq> getPr() {
        return pr;
    }
     ...
     *     
     */
    public void setPr(JAXBElement<WbsV4PlcyReq> value) {
        this.pr = value;
    }
