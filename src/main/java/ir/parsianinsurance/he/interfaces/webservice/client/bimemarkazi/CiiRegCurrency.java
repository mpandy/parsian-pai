 ...
 *       &lt;sequence>
 *         &lt;element name="Pr" type="{http://schemas.datacontract.org/2004/07/}WbsV4CurrencyReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegCurrency")
public class CiiRegCurrency {

    @XmlElementRef(name = "Pr", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4CurrencyReq> pr;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4CurrencyReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4CurrencyReq> getPr() {
        return pr;
    }
     ...
     *     
     */
    public void setPr(JAXBElement<WbsV4CurrencyReq> value) {
        this.pr = value;
    }
