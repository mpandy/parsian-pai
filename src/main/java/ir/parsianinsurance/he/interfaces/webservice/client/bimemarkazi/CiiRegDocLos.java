 ...
 *       &lt;sequence>
 *         &lt;element name="req" type="{http://schemas.datacontract.org/2004/07/}WbsV4DocLosReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegDocLos")
public class CiiRegDocLos {

    @XmlElementRef(name = "req", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4DocLosReq> req;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4DocLosReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4DocLosReq> getReq() {
        return req;
    }
     ...
     *     
     */
    public void setReq(JAXBElement<WbsV4DocLosReq> value) {
        this.req = value;
    }
