 ...
 *       &lt;sequence>
 *         &lt;element name="req" type="{http://schemas.datacontract.org/2004/07/}WbsV4EdrsReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegEdrs")
public class CiiRegEdrs {

    @XmlElementRef(name = "req", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4EdrsReq> req;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4EdrsReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4EdrsReq> getReq() {
        return req;
    }
     ...
     *     
     */
    public void setReq(JAXBElement<WbsV4EdrsReq> value) {
        this.req = value;
    }
