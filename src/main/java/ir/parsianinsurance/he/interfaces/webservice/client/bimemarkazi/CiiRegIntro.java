 ...
 *       &lt;sequence>
 *         &lt;element name="Pr" type="{http://schemas.datacontract.org/2004/07/}WbsV4IntroReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegIntro")
public class CiiRegIntro {

    @XmlElementRef(name = "Pr", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4IntroReq> pr;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4IntroReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4IntroReq> getPr() {
        return pr;
    }
     ...
     *     
     */
    public void setPr(JAXBElement<WbsV4IntroReq> value) {
        this.pr = value;
    }
