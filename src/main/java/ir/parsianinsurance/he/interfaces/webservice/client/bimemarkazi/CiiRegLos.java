 ...
 *       &lt;sequence>
 *         &lt;element name="losReq" type="{http://schemas.datacontract.org/2004/07/}WbsV4LosReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegLos")
public class CiiRegLos {

    @XmlElementRef(name = "losReq", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4LosReq> losReq;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4LosReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4LosReq> getLosReq() {
        return losReq;
    }
     ...
     *     
     */
    public void setLosReq(JAXBElement<WbsV4LosReq> value) {
        this.losReq = value;
    }
