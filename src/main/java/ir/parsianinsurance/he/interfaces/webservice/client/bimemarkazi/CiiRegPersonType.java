 ...
 *       &lt;sequence>
 *         &lt;element name="Pr" type="{http://schemas.datacontract.org/2004/07/}WbsV4PersonTypeReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegPersonType")
public class CiiRegPersonType {

    @XmlElementRef(name = "Pr", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4PersonTypeReq> pr;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4PersonTypeReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4PersonTypeReq> getPr() {
        return pr;
    }
     ...
     *     
     */
    public void setPr(JAXBElement<WbsV4PersonTypeReq> value) {
        this.pr = value;
    }
