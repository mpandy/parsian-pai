 ...
 *       &lt;sequence>
 *         &lt;element name="Pr" type="{http://schemas.datacontract.org/2004/07/}WbsV4PlcyCvrReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegPlcyCvr")
public class CiiRegPlcyCvr {

    @XmlElementRef(name = "Pr", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4PlcyCvrReq> pr;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4PlcyCvrReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4PlcyCvrReq> getPr() {
        return pr;
    }
     ...
     *     
     */
    public void setPr(JAXBElement<WbsV4PlcyCvrReq> value) {
        this.pr = value;
    }
