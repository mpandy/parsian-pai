 ...
 *       &lt;sequence>
 *         &lt;element name="Pr" type="{http://schemas.datacontract.org/2004/07/}WbsV4PlcyMthReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiRegPlcyMth")
public class CiiRegPlcyMth {

    @XmlElementRef(name = "Pr", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4PlcyMthReq> pr;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4PlcyMthReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4PlcyMthReq> getPr() {
        return pr;
    }
     ...
     *     
     */
    public void setPr(JAXBElement<WbsV4PlcyMthReq> value) {
        this.pr = value;
    }
