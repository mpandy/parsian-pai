 ...
 *       &lt;sequence>
 *         &lt;element name="req" type="{http://schemas.datacontract.org/2004/07/}UpdWbsV4DocLosReq" minOccurs="0"/>
...
@XmlRootElement(name = "CiiUpdDocLos")
public class CiiUpdDocLos {

    @XmlElementRef(name = "req", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<UpdWbsV4DocLosReq> req;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link UpdWbsV4DocLosReq }{@code >}
     *     
     */
    public JAXBElement<UpdWbsV4DocLosReq> getReq() {
        return req;
    }
     ...
     *     
     */
    public void setReq(JAXBElement<UpdWbsV4DocLosReq> value) {
        this.req = value;
    }
