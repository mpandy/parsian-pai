 ...
 *       &lt;sequence>
 *         &lt;element name="req" type="{http://schemas.datacontract.org/2004/07/}WbsV4LifeLosReq" minOccurs="0"/>
...
@XmlRootElement(name = "RegLifeLos")
public class RegLifeLos {

    @XmlElementRef(name = "req", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4LifeLosReq> req;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4LifeLosReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4LifeLosReq> getReq() {
        return req;
    }
     ...
     *     
     */
    public void setReq(JAXBElement<WbsV4LifeLosReq> value) {
        this.req = value;
    }
