 ...
 *       &lt;sequence>
 *         &lt;element name="req" type="{http://schemas.datacontract.org/2004/07/}WbsV4PlcyLifeReq" minOccurs="0"/>
...
@XmlRootElement(name = "RegPlcyLife")
public class RegPlcyLife {

    @XmlElementRef(name = "req", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4PlcyLifeReq> req;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4PlcyLifeReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4PlcyLifeReq> getReq() {
        return req;
    }
     ...
     *     
     */
    public void setReq(JAXBElement<WbsV4PlcyLifeReq> value) {
        this.req = value;
    }
