 ...
 *       &lt;sequence>
 *         &lt;element name="req" type="{http://schemas.datacontract.org/2004/07/}WbsV4PlcyLifeBaseReq" minOccurs="0"/>
...
@XmlRootElement(name = "RegPlcyLifeBase")
public class RegPlcyLifeBase {

    @XmlElementRef(name = "req", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<WbsV4PlcyLifeBaseReq> req;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link WbsV4PlcyLifeBaseReq }{@code >}
     *     
     */
    public JAXBElement<WbsV4PlcyLifeBaseReq> getReq() {
        return req;
    }
     ...
     *     
     */
    public void setReq(JAXBElement<WbsV4PlcyLifeBaseReq> value) {
        this.req = value;
    }
