 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://www.SMS.parsianInsurance.ir/", wsdlLocation = "http://172.16.0.166/smswebservice/service.asmx?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://www.SMS.parsianInsurance.ir/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://172.16.0.166/smswebservice/service.asmx?wsdl");
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("http://www.SMS.parsianInsurance.ir/", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.SMS.parsianInsurance.ir/", "ServiceSoap"), ServiceSoap.class, features);
    }
    ...
    public ServiceSoap getServiceSoap12() {
        return super.getPort(new QName("http://www.SMS.parsianInsurance.ir/", "ServiceSoap12"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.SMS.parsianInsurance.ir/", "ServiceSoap12"), ServiceSoap.class, features);
    }
    ...
    public ServiceHttpGet getServiceHttpGet() {
        return super.getPort(new QName("http://www.SMS.parsianInsurance.ir/", "ServiceHttpGet"), ServiceHttpGet.class);
    }
    ...
    public ServiceHttpGet getServiceHttpGet(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.SMS.parsianInsurance.ir/", "ServiceHttpGet"), ServiceHttpGet.class, features);
    }
    ...
    public ServiceHttpPost getServiceHttpPost() {
        return super.getPort(new QName("http://www.SMS.parsianInsurance.ir/", "ServiceHttpPost"), ServiceHttpPost.class);
    }
    ...
    public ServiceHttpPost getServiceHttpPost(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.SMS.parsianInsurance.ir/", "ServiceHttpPost"), ServiceHttpPost.class, features);
    }
